\begin{tcolorbox}[colback=cadmiumgreen!5!white,colframe=forestgreen!75!white,breakable,title=\textit{Optimized-setting with in-context learning prompt template for the mortality prediction task on the TJH.}]
\begin{VerbatimWrap}
