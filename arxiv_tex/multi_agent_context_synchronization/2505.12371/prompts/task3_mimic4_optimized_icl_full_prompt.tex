\begin{tcolorbox}[colback=cadmiumgreen!5!white,colframe=forestgreen!75!white,breakable,title=\textit{Optimized setting with in-context learning prompt template of optimized with in-context for the mortality prediction task on the MIMIC-IV.}]
\begin{VerbatimWrap}    
