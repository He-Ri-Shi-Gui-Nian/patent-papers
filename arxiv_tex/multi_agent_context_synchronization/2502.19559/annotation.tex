...
\begin{itemize}\itemsep 2pt
  \item Becker et al. \href{https://aclanthology.org/2025.emnlp-demos.29}{{MALLM}: Multi-Agent Large Language Models Framework}. 2025.
  \item Jonas Becker. \href{https://arxiv.org/abs/2410.22932}{Multi-Agent Large Language Models for Conversational Task-Solving}. 2024. 
  \item Kaesberg et al. \href{https://aclanthology.org/2025.findings-acl.606/}{Voting or Consensus? Decision-Making in Multi-Agent Debate}. 2025.
  \item Becker et al. \href{https://arxiv.org/abs/2405.15604}{Text Generation: A Systematic Literature Review of Tasks, Evaluation, and Challenges}. 2024.
\end{itemize}
\end{tcolorbox}
