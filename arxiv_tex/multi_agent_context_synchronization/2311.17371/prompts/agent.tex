...
\normalsize
Here we list all the agent-level prompts used in each of the strategies. The prompt names are linked to the entries in the Agent Prompt columns in Table \ref{app:tab:full-results-table}.
...
% \item[SUMMARIZER:]
% \begin{verbatim}
% Now use your previous summary, as well as the new agent responses, and generate an updated summary
% that will be provided to the agents.
% \n\nYour new summary: 
% \end{verbatim}
