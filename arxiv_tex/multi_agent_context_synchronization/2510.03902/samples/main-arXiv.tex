...
\fancyhead{}                                     % clear running headers
\fancyfoot{}                                     % (optional) clear footers incl. “Manuscript submitted…”
\setcopyright{none}    

% If any ACM copyright footnote tries to appear, nuke it:
\makeatletter
\renewcommand\footnotetextcopyrightpermission[1]{} % kills "Manuscript submitted to ACM"
\makeatother
...
\author{Rana Nameer Hussain Khan}
\email{rnameerkhan@vt.edu}
\affiliation{%
...
\renewcommand{\shortauthors}{Khan et al.}
...
\begingroup
\small
\input{samples/main-arXiv.bbl}  % <-- note the "samples/" prefix
\endgroup
