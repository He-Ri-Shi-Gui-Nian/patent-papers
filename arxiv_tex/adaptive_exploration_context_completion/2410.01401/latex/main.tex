...
\begin{figure}[t]
    \centering
    \includegraphics[page=1, scale=0.58]{latex/picture/motivation.pdf}
...
\begin{figure*}[t]
    \centering
    \includegraphics[page=1, scale=0.75]{latex/picture/overall.pdf}
...
\end{table*}
\begin{figure}[t]
\includegraphics[width=\linewidth]{latex/picture/Prepositional.png}
...
\begin{figure*}[t]
    \centering
    \includegraphics[page=1, scale=0.6]{latex/picture/case.pdf}
...
\begin{figure*}[t]
    ...
    \subcaption*{Epoch 1} 
        \includegraphics[width=\linewidth]{latex/picture/step1.png}

    \end{subfigure}
    \hfill
    \begin{subfigure}{0.31\textwidth}
    \subcaption*{Epoch 3}
        \includegraphics[width=\linewidth]{latex/picture/step3.png}
        
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.31\textwidth}
    \subcaption*{Epoch 5}
        \includegraphics[width=\linewidth]{latex/picture/all_question_ffn_2_layer_2.png}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}{0.31\textwidth}
    \subcaption*{Layer 21} 
        \includegraphics[width=\linewidth]{latex/picture/all_question_ffn_2_layer_0.png}
        
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.31\textwidth}
    \subcaption*{Layer 22}
        \includegraphics[width=\linewidth]{latex/picture/all_question_ffn_2_layer_1.png}
...
\begin{figure}[t]
    ...
    \caption*{OBQA}
        \includegraphics[width=1\linewidth]{latex/picture/hyper_LLM_inject_layer_obqa.png}
        
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.23\textwidth}
    \caption*{Riddle}
        \includegraphics[width=1\linewidth]{latex/picture/hyper_LLM_inject_layer_riddle.png}
...
\begin{figure*}[h]
    \centering
    \includegraphics[page=1, scale=0.65]{latex/picture/case_error.pdf}
