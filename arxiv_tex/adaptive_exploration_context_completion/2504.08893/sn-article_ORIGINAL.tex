...
\title[KG-RAG for Question Answering]{Knowledge Graph-Retrieval Augmented Generation for Question Answering}
...
\author[1]{\fnm{Jasper} \sur{Linders}}\email{iauthor@gmail.com}

\author*[1]{\fnm{Jakub M.} \sur{Tomczak}}\email{jmk.tomczak@gmail.com}
