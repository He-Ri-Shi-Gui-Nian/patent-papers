...
% \setlength{\intextsep}{0.3\intextsep}
...
\newtcolorbox{mtbox}[1]{left=0.25mm, right=0.25mm, top=0.25mm, bottom=0.25mm, sharp corners, colframe=red!50!black, boxrule=0pt, title={#1}, frame empty, fonttitle=\bfseries, coltitle=red!50!black, attach title to upper={\ --\ }}

% Define a new tcolorbox environment named crossbox
% \newtcolorbox{crossbox}[1]{
%   colframe=blue!50!black,    % Frame color
%   colback=blue!5,            % Background color
%   coltitle=blue!50!black,    % Title color
%   fonttitle=\bfseries,       % Title font style
%   sharp corners,             % Sharp corners for the box
%   boxrule=0.5mm,             % Thickness of the box border
%   title={#1},                % Title of the box
%   attach title to upper={\ --\ }, % Title attachment style
%   left=1mm, right=1mm, top=1mm, bottom=1mm % Margins inside the box
% }
